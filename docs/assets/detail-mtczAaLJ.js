      ...
      <div class="container">
        <div class="wrapper">
          ...
          <div class="price">
            ...
            <input @input=${this.handleDiscount} type="text" id="price" value="${i}" />
          </div>

          <div class="discount">
            <label for="discount">할인율</label>
            <input @input=${this.handleDiscount} type="text" id="discount" value="${o}" />
          </div>
